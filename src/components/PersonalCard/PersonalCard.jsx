        ...
        <div className="personal-card container px-4">
            ...
            <div className="perfiles">
                ...
                <div className="d-flex gap-3">
                    <Link to=""><img className="profile-icons" src={logoLikedin}/></Link>
                    <Link to=""><img className="profile-icons" src={logoGithub}/></Link>
                    <Link to=""><img className="profile-icons" src={logoX}/></Link>
                </div>
            </div>
        </div>
    )
