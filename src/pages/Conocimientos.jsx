        ...
        <>
            ...
            <div className="container row d-flex flex-wrap justify-content-center">
                <div className="col-12 col-sm-8">
                    ...
                    <InfoCard title={'Conocimientos extras'} url={"Conocimientos adicionales"} urlTitle={"Es bueno saber"} img={extras} description={"Detallo aquí otros conocimientos que tengo: Ubuntu, terminal/consola, Windows, redes sociales, SEO, Hootsuite, chatGPT, Copilot, Gemini, trading, TradingView, Slack, Netlify, QuickDBD."} />
