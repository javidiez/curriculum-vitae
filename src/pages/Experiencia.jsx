        ...
        <>
            ...
            <div className="container row d-flex flex-wrap justify-content-center">
                <div className="col-12 col-sm-8">
                    ...
                    <InfoCard title={'Project Business Analyst - Odoo'} url={"sept. 2021 - jun. 2022 (10 meses)"} urlTitle={"GuadalTech"} img={gt} description={"Tras mi regreso a España (Sevilla), GuadalTech me abrió las puertas para que pueda continuar mi carrera como Gestor de proyectos y Consultor, llevando a cabo más de 10 proyectos, desde el proceso comercial haciendo demos a los posibles clientes hasta su formación y soporte post salida a producción. (Ubicación: Sevilla, España)"}/>
